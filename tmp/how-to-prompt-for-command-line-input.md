...
<a class="hiddenLink" id="prompting-for-command-line-input"></a>
...
For more information on Prompt, please see [the project's GitHub page](http://github.com/nodejitsu/node-prompt).&lt/div>
