...
<a class="hiddenLink" id="using-ecma5-in-nodejs"></a>

## Using ECMA5 in Node.js
<span class="cite">by Community (Last Updated: Aug 26 2011)</span>
 ...
 * `"use strict";`:  This syntax extension is a [v8 issue](http://code.google.com/p/v8/issues/detail?id=919)&lt/div>
