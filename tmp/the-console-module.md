...
<a class="hiddenLink" id="the-console-module"></a>
...
For a complete list of properties and methods available to `console`, see [the official Node.js documentation](http://nodejs.org/docs/latest/api/stdio.html).&lt/div>
