...
<a class="hiddenLink" id="parsing-command-line-arguments"></a>
...
For more information on Optimist and the many, many other things it can do for your command-line arguments, please visit [its GitHub page](https://github.com/substack/node-optimist).&lt/div>
