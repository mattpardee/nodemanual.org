...
<a class="hiddenLink" id="understanding-event-emitters"></a>
...
For more information, you can refer to [the official Node.js reference page on the `EventEmitter` object](http://nodejs.org/docs/latest/api/events.html).&lt/div>
