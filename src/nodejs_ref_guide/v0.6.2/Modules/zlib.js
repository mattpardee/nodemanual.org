 ...
 * - `options` The standard [`options`](#options) object available to all the methods.
**/
 ...
 * - `buf` A buffer
 * - `callback()` The function to execute once the method completes
 * -- `error` The standard error object
