...
/**
 * fs.symlink(linkdata, path, [callback(err)]) -> Void
...
/**
 * fs.symlinkSync(linkdata, path) -> Void
 * - linkdata (String): The original path of a file
 * - path (String): The new file link path
 *  
 ...
 * #### Example
 * 
 * <script src='http://64.30.143.68/serve?repo=git%3A%2F%2Fgist.github.com%2F1562868.git&file=fs.writefile.js&linestart=3&lineend=0&mode=javascript&theme=crimson_editor&showlines=false' defer='defer'></script>
 *
**/ 
