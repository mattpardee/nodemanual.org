...
* 
*  - V8 Javascript, a C++ library. Used for interfacing with Javascript: creating objects, calling functions, etc. These are documented mostly in the `v8.h` header file (`deps/v8/include/v8.h` in the Node.js source tree), and also available [online](http://izs.me/v8-docs/main.html).
* 
...
* [https://github.com/pietern/hiredis-node](https://github.com/pietern/hiredis-node">https://github.com/pietern/hiredis-node) for a real-world production example.
* 
* #### Addon patterns
 * 
